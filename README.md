...
**Mower Electrical:**
  ...
  - Use a DC current limited power supply for charging. Toss out their charging board and power supply. I cap charger at 4 Amps & 20.5v - about 2A/battery, but still under the 5A / battery limit if one of the two batteries failed. 20.5v is 90% capacity for a 5s battery pack, or treat your batteries nice and charge to 20.0v for that sweet 80% capacity. Reuse the charging dock metal contacts and the metal contacts on the mower cover.
